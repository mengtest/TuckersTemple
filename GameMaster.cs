...
public class GameMaster : MonoBehaviour
{
        ...
        switch (dir)
        {
            ...
            case N:
                ...
                for (int r = numRows - 1; r > 0; r--)
                {
                    ...
                    tileGrid[col][r].GetComponent<NPCControl>().goalPos = new Vector2(offset.x + tileGrid[col][r].transform.position.x, offset.y + tileGrid[col][r].transform.position.y);
                }
                tileGrid[col][0] = temp;
                tileGrid[col][0].GetComponent<NPCControl>().offGrid = true;
                tileGrid[col][0].GetComponent<NPCControl>().goalPos     = new Vector2(offset.x + tileGrid[col][0].transform.position.x, offset.y + tileGrid[col][0].transform.position.y);
                tileGrid[col][0].GetComponent<NPCControl>().wrapPos     = new Vector2(tileSize * col, -tileSize);
                tileGrid[col][0].GetComponent<NPCControl>().wrapGoalPos = new Vector2(tileSize * col, 0);
            ...
            case S:
                ...
                tileGrid[col][numRows - 1].GetComponent<NPCControl>().offGrid = true;
                tileGrid[col][numRows - 1].GetComponent<NPCControl>().goalPos     = new Vector2(offset.x + tileGrid[col][numRows - 1].transform.position.x, offset.y + tileGrid[col][numRows - 1].transform.position.y);
                tileGrid[col][numRows - 1].GetComponent<NPCControl>().wrapPos     = new Vector2(tileSize * col, numRows * tileSize);
                tileGrid[col][numRows - 1].GetComponent<NPCControl>().wrapGoalPos = new Vector2(tileSize * col, (numRows - 1) * tileSize);
                break;
            case E:
                offset.x = tileSize;
                ...
                for (int c = numCols - 1; c > 0; c--)
                {
                    ...
                    tileGrid[c][row].GetComponent<NPCControl>().goalPos = new Vector2(offset.x + tileGrid[c][row].transform.position.x, offset.y + tileGrid[c][row].transform.position.y);
                }
                tileGrid[0][row] = temp;
                tileGrid[0][row].GetComponent<NPCControl>().offGrid = true;
                tileGrid[0][row].GetComponent<NPCControl>().goalPos     = new Vector2(offset.x + tileGrid[0][row].transform.position.x, offset.y + tileGrid[0][row].transform.position.y);
                tileGrid[0][row].GetComponent<NPCControl>().wrapPos     = new Vector2(-tileSize, tileSize * row);
                tileGrid[0][row].GetComponent<NPCControl>().wrapGoalPos = new Vector2(0, tileSize * row);
                break;
            case W:
                offset.x = -tileSize;
                temp = tileGrid[0][row];
                ...
                tileGrid[numCols - 1][row].GetComponent<NPCControl>().offGrid = true;
                tileGrid[numCols - 1][row].GetComponent<NPCControl>().goalPos     = new Vector2(offset.x + tileGrid[numCols - 1][row].transform.position.x, offset.y + tileGrid[numCols - 1][row].transform.position.y);
                tileGrid[numCols - 1][row].GetComponent<NPCControl>().wrapPos     = new Vector2(numCols * tileSize, row * tileSize);
                tileGrid[numCols - 1][row].GetComponent<NPCControl>().wrapGoalPos = new Vector2((numCols - 1) * tileSize, row * tileSize);
                break;
        }
    }
    ...
    public bool doneSliding()
    {
        ...
        {
            if(tile.GetComponent<NPCControl>().fsm.CurrentStateID == StateID.Idle)
            {
                ++idleCount;
            }
        }
